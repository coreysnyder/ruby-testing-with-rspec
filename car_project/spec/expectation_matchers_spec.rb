describe 'Expectation Matchers' do
  ...
  describe 'collection matchers' do
    ...
    it 'will match arrays' do
      ...
      expect(array).to match_array([3,2,1]) # Similar but different order
      expect(array).not_to match_array([1,2])

      expect(array).to contain_exactly(3,2,1)   # similar to match_array, must have exact items in any order
